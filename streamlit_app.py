...
if 'schulen' not in st.session_state:
    st.session_state.schulen = []
if 'geschwister' not in st.session_state:
    st.session_state.geschwister = []
...
{{"competencies": [{{"name": "...", "description": "...", "strength": 85}}], "quotes": [{{"text": "...", "author": "..."}}]}}"""
    ...
    if st.button("PDF erstellen", type="primary", use_container
